    ...
    <div className="min-h-screen flex">
      ...
      <aside className="w-60 bg-white border-r border-gray-200 flex flex-col shrink-0">
        <div className="p-5 border-b border-gray-100">
          <Link href="/" className="block">
            ...
            <h1 className="text-base font-semibold text-gray-900 leading-snug">
              ระบบตรวจคุณภาพ<br />ข้อมูลเปิดภาครัฐ
            </h1>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-100 space-y-3">
          {user && (
            <>
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-xs font-semibold uppercase shrink-0">
                  {user.username[0]}
                </div>
          ...
          {sources.length > 0 && (
            <div className="text-xs text-gray-400">
              <div className="mb-1 font-medium text-gray-500">แหล่งข้อมูล</div>
