...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col">
      {/* Header */}
      <header className="w-full flex items-center justify-between px-8 py-5 border-b border-gray-100 bg-white/80 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold text-sm">
            GQC
          </div>
          <div>
            <div className="text-xs text-gray-400 leading-none">ระบบตรวจคุณภาพ</div>
            <div className="text-sm font-semibold text-gray-800 leading-tight">GDCatalog Quality Control System</div>
          </div>
        </div>
        ...
        {username ? (
          <div className="flex items-center gap-3">
            <span className="text-sm text-gray-600 hidden sm:block">
              ยินดีต้อนรับ <span className="font-semibold text-gray-800">{username}</span>
            </span>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4 max-w-3xl">
          GDCatalog Quality Control System
          <br />
          <span className="text-blue-600">ระบบตรวจคุณภาพข้อมูล GDCatalog Smart Plus</span>
        </h1>
